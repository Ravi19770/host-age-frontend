...
console.log("Billing Location State:", location.state);
console.log("Billing Selected Plan:", selectedPlan);
console.log("Billing Selected Domain:", selectedDomain);
